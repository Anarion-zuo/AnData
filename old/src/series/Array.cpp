...
bool anarion::IntegerArray::isBig() const {
    return false;
}
...
bool anarion::FloatArray::isBig() const {
    return false;
}
...
bool anarion::BigIntegerArray::isBig() const {
    return true;
}
...
bool anarion::BigFloatArray::isBig() const {
    return true;
}
